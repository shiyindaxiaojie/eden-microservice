...
func LoadConfig(path string) (*Config, error) {
	...
	viper.SetDefault("server.http", ":8500")
	viper.SetDefault("server.grpc", "auto")
	viper.SetDefault("server.quic", "off")
	viper.SetDefault("server.raft", "auto")
	...
	viper.SetDefault("storage.event_types", defaultRegistryEventTypes())
...
func defaultRegistryEventTypes() []string {
	return []string{
		"service_register",
		"service_online",
		"service_offline",
