...
本目录是一套独立的 `pkg/eden` 服务发现示例，包含两种完全分开的接入方式：
...
```bash
./examples/service-discovery/eden/start-grpc.bat
```

服务名：

- `eden-grpc-auth-center`
- `eden-grpc-user-center`
- `eden-grpc-order-center`
...
```bash
./examples/service-discovery/eden/start-http.bat
```

服务名：

- `eden-http-auth-center`
- `eden-http-user-center`
- `eden-http-order-center`
