...
import (
	...
	"eden-microservice/apps/cluster/api"
	"eden-microservice/apps/cluster/api/alert"
	"eden-microservice/apps/cluster/api/notify"
...
type Handler struct {
	...
	consul         *registrymodule.ConsulHTTPAdapter
	nacos          *registrymodule.NacosHTTPAdapter
	nacosConfig    *configmodule.NacosHTTPAdapter
...
func NewHandler(cfg *config.Config,
	...
	h := &Handler{
		...
		consul:         registrymodule.NewConsulHTTPAdapter(cfg, catalogRegistry),
		nacos:          registrymodule.NewNacosHTTPAdapter(catalogRegistry),
		nacosConfig:    configmodule.NewNacosHTTPAdapter(configService),
		nodeCache:      sync.Map{},
